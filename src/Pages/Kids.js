  ...
  return (
    <div className="px-8 pt-24 py-2">
      <div className="animated-gradient rounded-lg py-11 p-8 text-center mb-8">
        ...
        <p className="text-lg font-semibold text-gray-700 mb-5 mt-2">5 Hours 30 Mins</p>
        <a  href="#kids"   className="mt-4 px-6 py-3 bg-orange-500 text-white font-semibold rounded-full hover:bg-orange-600 transition-colors">
          Explore now
        </a>
      </div>
      ...
      <div id='kids' className="grid grid-cols-4 gap-8">
